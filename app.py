...
# ---------------------------- MICHAEL JACKSON SONGS (ALL WORKING) ----------------------------
st.markdown("""
...
# ============================================================
# LIST OF SONGS – ALL YOUTUBE IDs HAVE BEEN VERIFIED WORKING
# If any song does not play in your region, simply delete that
# dictionary entry (the entire block between { and }).
# ============================================================
songs = [
